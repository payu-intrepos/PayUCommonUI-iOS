...
#ifndef PAYUCOMMONUI_SWIFT_H
#define PAYUCOMMONUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayUCommonUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PayUCommonUI27PayUAnalyticsAdditionalInfo")
@interface PayUAnalyticsAdditionalInfo : NSObject
...
@property (nonatomic, copy) NSString * _Nullable enforcedValue;
@property (nonatomic, copy) NSString * _Nullable sdkVersion;
@property (nonatomic, copy) NSString * _Nullable ctaName;
@property (nonatomic, copy) NSString * _Nullable url;
@property (nonatomic, copy) NSString * _Nullable urlLoadingState;
@property (nonatomic, copy) NSString * _Nullable initiatorIdentifier;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDate;

SWIFT_CLASS("_TtC12PayUCommonUI20PayUAnalyticsManager")
@interface PayUAnalyticsManager : NSObject
- (nonnull instancetype)initWithAnalyticsAdditionalInfo:(PayUAnalyticsAdditionalInfo * _Nonnull)analyticsAdditionalInfo OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initForKibana:(PayUAnalyticsAdditionalInfo * _Nonnull)analyticsAdditionalInfo OBJC_DESIGNATED_INITIALIZER;
- (void)logEventWithEventName:(NSString * _Nonnull)eventName eventData:(NSDictionary<NSString *, id> * _Nonnull)eventData startDate:(NSDate * _Nullable)startDate;
- (void)logWithJson:(NSDictionary<NSString *, id> * _Nonnull)json;
- (void)logKibanaEventWithJson:(NSDictionary<NSString *, id> * _Nonnull)json;
...
SWIFT_CLASS("_TtC12PayUCommonUI12PayUBaseView")
...
SWIFT_CLASS("_TtC12PayUCommonUI17PayUCustomOverlay")
@interface PayUCustomOverlay : PayUBaseView
@property (nonatomic) NSTimeInterval animationDuration;
- (void)showOverlayOnView:(UIView * _Nonnull)onView subView:(UIView * _Nonnull)subView disableOnSwipe:(BOOL)disableOnSwipe disableOnTap:(BOOL)disableOnTap;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12PayUCommonUI12PayULogoView")
...
@interface PayULogoView (SWIFT_EXTENSION(PayUCommonUI))
...
@interface PayUUIConfigurations : NSObject
@property (nonatomic, strong) UIColor * _Nonnull primaryColor;
@property (nonatomic, strong) UIColor * _Nonnull secondaryColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class PayUUserCancellationViewModel;

SWIFT_CLASS("_TtC12PayUCommonUI24PayUUserCancellationView")
@interface PayUUserCancellationView : PayUBaseView
- (nonnull instancetype)initWithFrame:(CGRect)frame viewModel:(PayUUserCancellationViewModel * _Nonnull)viewModel uiConfigurations:(PayUUIConfigurations * _Nonnull)uiConfigurations OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@interface PayUUserCancellationView (SWIFT_EXTENSION(PayUCommonUI)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC12PayUCommonUI29PayUUserCancellationViewModel")
@interface PayUUserCancellationViewModel : NSObject
- (nonnull instancetype)initWithReasonList:(NSArray<NSString *> * _Nullable)reasonList headerText:(NSString * _Nullable)headerText analyticsAdditionalInfo:(PayUAnalyticsAdditionalInfo * _Nonnull)analyticsAdditionalInfo OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
